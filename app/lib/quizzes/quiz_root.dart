          ...
          if (snapshot.hasData && snapshot.data?.quizName != "ERROR") {
            ...
            bool addScore() {
              ...
              for (int i = 0;
                  ...
                  i++) {
                if (questions[questionIndex].getAlreadlySelectedIndex(i)) {
                  counter++;
                }
              }
              if (counter <= 1) {
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return GestureDetector(
                        ...
                        if (!questions[questionIndex]
                          ...
                          setState(() {
                            ...
                            if (questions[questionIndex]
                              ...
                              questions[questionIndex]
                                  .setColorIndex(currentlySelected, selected);
                            }
                          });
                        }
                      },
                      child: OptionCard(
                          option:
                              questions[questionIndex].answers[index].option,
                          color: questions[questionIndex].getColorIndex(index)),
                    );
                  },
                ),
              );
            ...
            //print(snapshot.data!.getQuestions()[0].answers);
            return Scaffold(

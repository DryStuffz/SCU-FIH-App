...
const blueDark = Color(0xFF2E2E50);
const blueGrey = Color(0xFF4A4E69);
const blueGreyLight = Color.fromARGB(255, 180, 180, 213);
const Color grey = Color(0xFFC1C1C1);
const Color purple = Color(0xFF715686);
